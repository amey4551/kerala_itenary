...
import { mapLocations, drivingTips } from '@/data/itineraryData';
      ...
      >
        ...
        >
          ...
          <p className="text-green-700 max-w-2xl mx-auto">
            Visualize your journey with this interactive map showing all destinations 
            in your Kerala adventure. Plan your route and explore the beautiful landscapes of God's Own Country.
          </p>
        </motion.div>
            ...
            {isMapLoaded ? (
              ...
              <div className="relative w-full h-full">
                <div className="absolute inset-0 flex items-center justify-center z-20 bg-green-500/10">
                  <div className="bg-white p-8 rounded-lg shadow-lg text-center max-w-md">
                    ...
                    <h3 className="text-xl font-semibold mb-2">Interactive Kerala Map</h3>
                    <p className="mb-4 text-gray-600">
                      This interactive map shows all locations from your Kerala itinerary with custom markers and navigation options.
                    </p>
              ...
              <div className="flex items-center justify-center h-full bg-green-50">
                <div className="text-center p-6">
                  ...
                  <h3 className="text-xl font-semibold mb-2 text-green-800">Loading Map</h3>
                  <p className="text-green-700 mb-6">Preparing your interactive Kerala travel map...</p>
        ...
        >
          ...
          >
            <h3 className="text-xl font-semibold text-green-800 mb-6 flex items-center">
              <span className="w-8 h-8 mr-3 rounded-full bg-green-100 flex items-center justify-center text-green-600">1</span>
              Day 1 Locations
            </h3>
            <ul className="space-y-4">
              {mapLocations.day1.map(location => (
                <li key={location.id} className="flex items-start">
                  <div className={`${location.isPriority ? 'bg-green-600' : 'bg-green-200'} h-6 w-6 rounded-full flex items-center justify-center text-white text-xs font-bold mr-3 mt-0.5`}>
                    {location.id}
                  </div>
                  <div>
          ...
          >
            <h3 className="text-xl font-semibold text-green-800 mb-6 flex items-center">
              <span className="w-8 h-8 mr-3 rounded-full bg-green-100 flex items-center justify-center text-green-600">2</span>
              Day 2 Locations
            </h3>
            <ul className="space-y-4">
        ...
        >
          <div className="flex items-center mb-4">
            ...
            <h3 className="text-xl font-semibold text-green-800">Driving Tips for Kerala</h3>
          </div>
